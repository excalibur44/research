...
print_info(){
    clear
    echo "##############################################################"
    echo "# Desc: Auto Install Shadowsocks-libev Server for Debian 7/8 #"
    echo "# Author: https://github.com/teddysun/shadowsocks_install    #"
    echo "# Modify: https://www.banwagongzw.com                        #"
    echo "##############################################################"
    echo
}
#Check system
...
pre_install(){
    ...
    if ! check_sys packageManager apt; then
        echo -e "[${red}Error${plain}] Your OS is not supported, please change OS to Debian and try again!"
        exit 1
    fi
    #Check version
    check_version
    ...
    read -p "(Default: banwagongzw.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="banwagongzw.com"
    echo "---------------------------"
